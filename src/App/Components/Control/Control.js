...
class Control extends React.Component {
    ...
    pauseVideo() {
        this.refs.noSleepVideo.pause();
    }

    playVideo() {
        this.refs.noSleepVideo.play();
    }
    ...
    render() {
        ...
        return (
            <div className={"buttons-control-group"} >
                {this.isRunning() ? (
                    <Pause
                        onClickPause={(event) => { onClickPause(); this.pauseVideo();}}
                    />
                ) : (
                    <Play
                        onClickPlay={(event) => { onClickPlay(); this.playVideo();}}
                    />
                )}
                <video className={"hidden"} id="noSleepVideo" ref="noSleepVideo" loop playsInline>
